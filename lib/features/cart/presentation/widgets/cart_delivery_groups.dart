...
/// Centered "Items will arrive in N Deliveries" heading, shown only once
/// there's genuinely more than one delivery group — the overwhelming
/// majority of carts ship as a single delivery, and showing this heading
/// then would just be noise above a lone group card.
class CartDeliveryGroupsHeading extends StatelessWidget {
  const CartDeliveryGroupsHeading({required this.groupCount, super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(
            'Items will arrive in $groupCount Deliveries',
            style: TextStyle(
              fontSize: 13.sp,
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 8.h),
            Text(
              'Some items in your cart take longer to prepare or deliver than '
              'others, so your order will arrive in separate deliveries — '
              'each shown below with its own estimate.',
              style: TextStyle(
                fontSize: 14.sp,
                height: 1.5,
